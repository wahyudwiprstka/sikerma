    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div class="flex flex-col items-center mb-6">
                <img class="w-[10rem]" src="/img/stikom.png" alt="logo">
                <h3 href="#" class="text-2xl font-bold text-gray-900 dark:text-white">
                    Sistem Informasi Pengelolaan Kerjasama ITB STIKOM Bali
                </h3>
            </div>
                    ...
                    <form class="space-y-4 md:space-y-6" action="/login" method="post">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email"
                                ...
                                placeholder="name@company.com" required {{ old('email') }}>
                            @error('email')
                                <p>{{ $message }}</p>
                            @enderror
                        </div>
